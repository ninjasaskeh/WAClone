...
import com.example.wacloneapp.adapter.SectionPagerAdapter
...
import com.example.wacloneapp.util.DATA_USER_PHONE
import com.example.wacloneapp.util.PERMISSION_REQUEST_READ_CONTACT
import com.example.wacloneapp.util.REQUEST_NEW_CHATS
...
class MainActivity : AppCompatActivity(), FailureCallback {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        chatsFragment.setFailureCallbackListner(this)
